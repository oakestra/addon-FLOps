...
from notification_management import notify_about_failed_build_and_terminate, notify_observer
...
def build_image(
    ...
    if should_notify_observer:
        notify_observer(build_start_msg)
