# TODO: Delete this file from the aggregator - it is a copy from the learner and only here for testing
import json
import pathlib
import shutil
import tempfile
...
def load_data_from_ml_data_server() -> datasets.Dataset:
    ...
    if number_of_downloaded_files == 0:
        logger.error("No matching data found for provided data tags 'mnist'")
        import sys
