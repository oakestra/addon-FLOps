...
\begin{figure}[h]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.90\paperwidth]{eval_1_simplest_cpu_boxviolin.png}
...
\begin{figure}[h]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.90\paperwidth]{eval_1_simplest_memory_boxviolin.png}
...
\begin{figure}[h]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.95\paperwidth]{eval_1_simplest_stage_durations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{eval_1_simplest_accuracy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{eval_1_simplest_loss.png}
