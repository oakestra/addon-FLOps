...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.85\paperwidth]{evaluations/multicluster_hfl/eval_8_6_monolith_hfl_cpu_mem.png}
...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.85\paperwidth]{evaluations/multicluster_hfl/eval_10_8_multicluster_hfl_cpu.png}
...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.85\paperwidth]{evaluations/multicluster_hfl/eval_10_8_multicluster_hfl_mem.png}
