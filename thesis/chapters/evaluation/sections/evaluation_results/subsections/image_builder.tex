...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.85\paperwidth]{eval_3_simple_baseimages_stage_durations.png}
...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.83\paperwidth]{eval_4_simple_multiplatform_cpu_and_mem.png}
...
\begin{figure}[H]
    \begin{adjustwidth}{-0.2\paperwidth}{-0.2\paperwidth}
        \centering
        \includegraphics[width=0.83\paperwidth]{eval_4_simple_multiplatform_stage_durations.png}
