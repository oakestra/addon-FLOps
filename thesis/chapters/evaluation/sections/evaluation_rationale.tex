...
\begin{figure}[p]
    \input{tables/evaluation_experiments.tex}
\end{figure}

% \begin{changemargin}{0cm}{0cm}
%     \centering
%     \begin{tabular}{|m{2.4cm}||c|c|c|c|c|c|c|c|}
%         \hline
%             \textbf{Experiment Name} & \textbf{Rationale} & \textbf{Machine Setup} & \textbf{Dataset} & \textbf{ML Framework} & \textbf{Project Size} & \textbf{FL Mode} & \textbf{Uses BaseImages} & \textbf{Platform} \\
%         \hline
%             Base Case - Simplest &
%             0.9.0 &
%             Monolith &
