...
from flops_manager.database.common import retrieve_from_db_by_app_id
...
def get_tracking_server(customer_id: str, observatory: FLOpsObservatory = None) -> TrackingServer:
    ...
    existing_tracking_server = retrieve_from_db_by_app_id(TrackingServer, customer_id)
    ...
    return TrackingServer(parent_app=observatory)
